  ...
  for (var i = 0; i < array.length; i++) {
    if (product_id.localeCompare(array[i].product_id) == 0) {
      a +=
        ...
        array[i].product_price +
        '</div><div id="detail_text">Hoặc trả góp trước với giá 1.000.000 ₫.<br>' +
        "Giảm đến 500K cho Sinh Viên ĐHSG khi thanh toán ngay !!!</div>" +
